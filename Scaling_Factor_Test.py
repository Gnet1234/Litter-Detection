...
gps_data_df = pd.DataFrame(columns=['Timestamp', 'Latitude (Degrees)', 'Longitude (Degrees)', 'Altitude (ft)', 'Objects', 'Confidence', 'Pixel Count', 'Pixel Height', 'True Height'])
...
class_names = {
    1: 'Metal Can',       # Example class IDs and names
    0: 'Water Bottle',
...
def save_to_excel(df):
    ...
    filename = 'Scaling_Factor_Test.xlsx'
