...
class StreamingExample:
    ...
    def yuv_frame_processing(self, running, output_dir=None):
        if output_dir is None:
            output_dir = "extracted_frames"  # Default directory
        ...
        while running.is_set():
            try:
                ...
                # Run inference and process the frame
                ...
                if boxes is not None and boxes.size(0) > 0:
                    ...
                    if results and hasattr(results[0], 'masks') and hasattr(results[0].masks, 'data') and hasattr(
                        ...
                        for i, (mask, bbox) in enumerate(zip(results[0].masks.data, results[0].boxes.xyxy)):
                            ...
                            # The static height is in feet, this would the distance between the camera and the object
                            Static_Height = 1.47638
